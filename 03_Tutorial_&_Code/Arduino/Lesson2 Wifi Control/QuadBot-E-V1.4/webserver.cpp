...
void handleIndex()
{
	...
	content += "<td width=33%><button type=button style=background:#BFFFCF onclick=controlPm(6)>Turn left</button></td>"; //Turn left
	content += "<td width=33%><button type=button onclick=controlPm(2)>Forward</button></td>"; //Forward
	content += "<td width=33%><button type=button style=background:#BFFFCF onclick=controlPm(7)>Turn Right</button></td>"; //Turn Right
	content += "</tr>";
	content += "<tr height=19%>";
	content += "<td><button type=button onclick=controlPm(4)>Left shift</button></td>"; //Left shift
	content += "<td><button type=button onclick=controlPm(3)>Backward</button></td>"; //Backward
	content += "<td><button type=button onclick=controlPm(5)>Right shift</button></td>"; //Right shift
	content += "</tr>";
	content += "<tr height=5%><td colspan=3><span><br></span></td></tr>";
	content += "<tr height=20%>";
	content += "<td><button type=button style=background:#FFCC99 onclick=controlPm(1)>Standby</button></td>"; //Standby
	content += "<td><button type=button style=background:#FFE599 onclick=controlPm(9)>Say Hi</button></td>"; //Say Hi
	content += "<td><button type=button style=background:#FFE599 onclick=controlPm(11)>Push up</button></td>"; //Push up
	content += "</tr>";
	content += "<tr height=19%>";
	content += "<td><button type=button style=background:#FFE599 onclick=controlPm(8)>Lie</button></td>"; //Lie
	content += "<td><button type=button style=background:#FFE599 onclick=controlPm(10)>Fighting</button></td>"; //Fighting
	content += "<td><button type=button style=background:#FFBFBF onclick=controlPm(12)>Sleep</button></td>"; //Sleep
	content += "</tr>";
	content += "<tr height=19%>";
	content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(13)>Disco</button></td>"; //Dance1
	content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(14)>Rock</button></td>"; //Dance2
	content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(15)>Chok</button></td>"; //Dance3
	content += "</tr>";
	content += "</table>";
